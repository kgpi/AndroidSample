...
public class ListViewActivity extends AppCompatActivity {
    ...
    class PersonListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ((TextView)convertView.findViewById(R.id.noTextView)).setText(personModels.get(position).getNo());
            ((TextView)convertView.findViewById(R.id.lastNameTextView)).setText(personModels.get(position).getLastName());
            ((TextView)convertView.findViewById(R.id.ageTextView)).setText(personModels.get(position).getAge());
